...
if (isset($_POST['submit']))
{
 ...
 $user = $stmt->fetch();
  ...
  if ($user) { // if user exists
    ...
    var_dump($errors); //Just for checking :)
  } 
  else 
  {
            ...
            <div class="col-md-6 col-lg-7 d-flex align-items-center">
              <div class="card-body p-4 p-lg-5 text-black">
                ...
                <form action="SignIn.php" method="POST" >
                  ...
                  <div class="form-outline mb-4">
                    <input type="text" id="form2Example17" class="form-control form-control-lg" name="name" placeholder="Name" />
                   
                  </div>
                  <div class="form-outline mb-4">
                    <input type="text" id="form2Example17" class="form-control form-control-lg" name="address" placeholder="Address" />
                  </div>
                  ...
                  <p class="mb-5 pb-lg-2" style="color: #393f81;">You have an account? <a href="#!"
